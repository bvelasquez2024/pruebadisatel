...
if($_SESSION["perfil"] == "Especial" || $_SESSION["perfil"] == "Usuario"){
...
======================================-->
  ...
  <div class="input-group">
    ...
    <input type="text" class="form-control input-lg" name="nuevoUsuario" id="nuevoUsuario" placeholder="Ingresar usuario" required readonly>
  </div>
</div>
